...
interface HistoriaPersonalProps {
  desarrolloEvolutivo?: string;
  historiaAcademicaLaboral?: string;
  historiaMedica?: string;
  medicacionActual?: string;
  consumoAlcohol?: string;
  consumoTabaco?: string;
  consumoDrogas?: string;
  tuveTratamientosPrevios?: boolean;
  detallesTratamientosPrevios?: string;
  tuveHospitalizaciones?: boolean;
  detallesHospitalizaciones?: string;
  onChange?: (data: HistoriaPersonalData) => void;
  disabled?: boolean;
}

export interface HistoriaPersonalData {
  desarrolloEvolutivo: string;
  historiaAcademicaLaboral: string;
  historiaMedica: string;
  medicacionActual: string;
...
export default function HistoriaPersonal({
  ...
  const [formData, setFormData] = useState<HistoriaPersonalData>({
    desarrolloEvolutivo,
    historiaAcademicaLaboral,
    historiaMedica,
    medicacionActual,
    ...
    consumoTabaco,
    consumoDrogas,
    tuveTratamientosPrevios,
    detallesTratamientosPrevios,
    tuveHospitalizaciones,
    detallesHospitalizaciones,
  });
  ...
  const handleInputChange = (
    field: keyof HistoriaPersonalData,
  ...
  const handleTratamientosChange = (checked: boolean) => {
    setFormData((prev) => ({
      ...prev,
      tuveTratamientosPrevios: checked,
      detallesTratamientosPrevios: checked
        ? prev.detallesTratamientosPrevios
        : "",
    }));
  };
  ...
  const handleHospitalizacionesChange = (checked: boolean) => {
    setFormData((prev) => ({
      ...prev,
      tuveHospitalizaciones: checked,
      detallesHospitalizaciones: checked ? prev.detallesHospitalizaciones : "",
    }));
  };
