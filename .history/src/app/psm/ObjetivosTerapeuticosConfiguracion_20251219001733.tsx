        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <TextArea
              ...
              onChange={(e) =>
                handleInputChange("objetivoCortoplazo", e.target.value)
              }
              disabled={disabled}
              required
          ...
          <div>
            ...
            <TextArea
              ...
              onChange={(e) =>
                handleInputChange("objetivoMedioplazo", e.target.value)
              }
              disabled={disabled}
              className="max-w-full"
              rows={4}
          ...
          <div>
            ...
            <TextArea
              ...
              onChange={(e) =>
                handleInputChange("objetivoLargoplazo", e.target.value)
              }
              disabled={disabled}
              className="max-w-full"
              rows={4}
            ...
            <div className="space-y-3 rounded-lg bg-gray-50 p-4 dark:bg-gray-800">
              {modalidadOptions.map((option) => (
                <Checkbox
                  ...
                  onChange={(e) =>
                    handleModalidadChange(option.value, e.target.checked)
                  }
                  disabled={disabled}
                />
              ))}
            ...
            <div className="space-y-3 rounded-lg bg-gray-50 p-4 dark:bg-gray-800">
              {enfoqueTerapeuticoOptions.map((option) => (
                <Checkbox
                  ...
                  onChange={(e) =>
                    handleEnfoqueChange(option.value, e.target.checked)
                  }
                  disabled={disabled}
                />
              ))}
