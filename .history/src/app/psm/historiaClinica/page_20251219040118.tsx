...
const TABS: { key: TabKey; label: string; icon: JSX.Element }[] = [
  ...
  { 
    ...
    icon: <MdTarget className="size-5" /> 
  },
  { 
    key: "sesiones", 
    label: "Notas de Progreso", 
    icon: <MdEventNote className="size-5" /> 
  },
  { 
    key: "evaluaciones", 
    label: "Evaluaciones Periódicas", 
    icon: <MdTrendingUp className="size-5" /> 
  },
  { 
    key: "alta", 
      ...
      <div className="mb-6">
        ...
        <div className="border border-gray-200 rounded-xl dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm">
          <div className="border-b border-gray-200 dark:border-gray-800">
            <nav className="-mb-px flex space-x-1 overflow-x-auto px-4 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-thumb]:bg-gray-700 [&::-webkit-scrollbar]:h-1.5">
              {TABS.map((tab) => (
                <button
                  key={tab.key}
                  ...
                  <div className="divide-y divide-gray-200 dark:divide-gray-800">
                    ...
                    {sesionesEjemplo.length === 0 && (
                      <div className="px-4 py-8 text-center text-gray-500 dark:text-gray-400">
                        <MdEventNote className="size-12 mx-auto mb-3 text-gray-300 dark:text-gray-600" />
                ...
                <div className="mb-6 overflow-hidden rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-900/50">
                  <div className="divide-y divide-gray-200 dark:divide-gray-800">
                    ...
                    {evaluacionesEjemplo.length === 0 && (
                      <div className="px-4 py-8 text-center text-gray-500 dark:text-gray-400">
                        <MdTrendingUp className="size-12 mx-auto mb-3 text-gray-300 dark:text-gray-600" />
                ...
                <div className="mb-6 overflow-hidden rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-900/50">
                  <div className="divide-y divide-gray-200 dark:divide-gray-800">
                    ...
                    {altasEjemplo.length === 0 && (
                      <div className="px-4 py-8 text-center text-gray-500 dark:text-gray-400">
                        <MdExitToApp className="size-12 mx-auto mb-3 text-gray-300 dark:text-gray-600" />
