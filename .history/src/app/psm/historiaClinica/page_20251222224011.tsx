          ...
          <div className="border-b border-gray-200 dark:border-gray-800">
            <nav className="-mb-px flex flex-wrap gap-1 px-4">
              {TABS.map((tab) => (
                ...
                <button
              className="ml-4 flex items-center gap-2 rounded bg-red-100 px-3 py-2 text-red-700 font-medium hover:bg-red-200 transition-colors"
              title="Salir de la historia clínica"
              onClick={() => {
