...
interface DatosIdentificacionPacienteProps {
...
export interface DatosIdentificacionData {
  nombreCompleto: string;
  fechaNacimiento: string;
  edad: number;
  genero: string;
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="mt-3 space-y-3">
            ...
            />
            <Radio
              id="genero-no-especificar"
              name="genero"
              value="prefiero_no_especificar"
              label="Prefiero no especificar"
              checked={formData.genero === "prefiero_no_especificar"}
              onChange={(e) => handleInputChange("genero", e.target.value)}
              disabled={disabled}
            />
          </div>
          ...
          <div className="mt-3 space-y-3">
            {procedenciaOptions.map((option) => (
              <Checkbox
                ...
                value={option.value}
                label={option.label}
                checked={formData.procedencia.includes(option.value)}
                onChange={(e) =>
                  handleProcedenciaChange(option.value, e.target.checked)
                }
                disabled={disabled}
              />
            ))}
