    ...
    <div className="rounded-lg border border-gray-300 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-900">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        <div>
          ...
          <Input placeholder={hcs?.nombreInstitucion || ""} />
        </div>
        ...
        <div>
          ...
          <Input placeholder={hcs?.servicioNombre || ""} />
        </div>
        ...
        <div>
          ...
          <Input placeholder={hcs?.psicologoResponsable || ""} disabled />
        </div>
        ...
        <div>
          ...
          <Input placeholder={hcs?.numeroColegiado || ""} disabled />
        </div>
      </div>
    </div>
  );
