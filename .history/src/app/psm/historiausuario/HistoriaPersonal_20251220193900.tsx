      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <TextArea
            ...
            onChange={(e) =>
              handleInputChange("hacademica", e.target.value)
            }
            disabled={readOnly}
            className="max-w-full"
            rows={5}
        ...
        <div>
          ...
          <TextArea
            ...
            onChange={(e) =>
              handleInputChange("hmedica", e.target.value)
            }
            disabled={readOnly}
            className="max-w-full"
            rows={5}
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <TextArea
                ...
                onChange={(e) =>
                  handleInputChange("consumoDrogras", e.target.value)
                }
                disabled={readOnly}
                className="max-w-full"
                rows={4}
          ...
          {formData.hospitalizaciones && (
            <div className="mt-4">
              ...
              <TextArea
                ...
                onChange={(e) =>
                  handleInputChange("hospitalizacionesDetalles", e.target.value)
                }
                disabled={readOnly}
                className="max-w-full"
                rows={5}
