        ...
        <div className="flex flex-col flex-1 lg:w-1/2 w-full overflow-y-auto no-scrollbar">
            ...
            <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
                ...
                <div>
                    ...
                    <div className="mt-5">
                        <p className="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start"> Wait, I remember my password... <a href="#" className="text-brand-500 hover:text-brand-600 dark:text-brand-400">Click here</a></p>
                    </div>
                </div>
            </div>
        </div>
