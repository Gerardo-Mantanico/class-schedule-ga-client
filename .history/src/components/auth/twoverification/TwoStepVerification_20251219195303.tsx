    ...
    return (
        <div className="flex flex-col flex-1 lg:w-1/2 w-full overflow-y-auto no-scrollbar">
            ...
            <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-5 bg-white dark:bg-dark-900 rounded-lg shadow-theme-xs p-6 border border-gray-200 dark:border-gray-800">
                    <div>
                        ...
                        <Input
                            ...
                            required
                            className="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-center text-xl font-semibold text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"
                        />
                    </div>
                ...
                <div className="mt-5">
                    <p className="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start">
                        ...
                        <a href="/auth/signIn" className="text-brand-500 hover:text-brand-600 dark:text-brand-400">Click here</a>
                    </p>
                    <p className="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start mt-2">
                        Didn’t get the code?{' '}
                        <a href="#" className="text-brand-500 hover:text-brand-600 dark:text-brand-400">Resend</a>
                    </p>
                </div>
            </div>
        </div>
