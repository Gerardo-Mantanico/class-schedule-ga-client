    ...
    <div className="mx-auto max-w-7xl p-4 pb-20 md:p-6 md:pb-6">
      <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
        ...
        <nav>
          <ol className="flex items-center gap-1.5">
            <li>
              <a href="/" className="inline-flex items-center gap-1.5 text-sm text-gray-500 dark:text-gray-400">
                Hogar
      ...
      <div className="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        <div>
          <div className="flex flex-col items-center px-4 py-5 xl:px-6 xl:py-6">
            <div className="flex flex-col w-full gap-5 sm:justify-between xl:flex-row xl:items-center">
              <div className="flex flex-wrap items-center gap-x-1 gap-y-2 rounded-lg bg-gray-100 p-0.5 dark:bg-gray-900">
                <Button className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-md group hover:text-gray-900 dark:hover:text-white text-gray-900 dark:text-white bg-white dark:bg-gray-800">
                  Todas las tareas
          ...
          <div className="grid grid-cols-1 border-t border-gray-200 divide-x divide-gray-200 dark:border-gray-800 mt-7 dark:divide-gray-800 sm:mt-0 sm:grid-cols-2 xl:grid-cols-3">
              ...
              <div className="overflow-hidden">
                <div className="p-4 xl:p-6">
                  ...
                  <div className="min-h-[200px] space-y-5 mt-5">
                    ...
                    {/* Solo he incluido una tarea como ejemplo para mantener la respuesta manejable */}
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="overflow-hidden">
                <div className="p-4 xl:p-6">
                  <div className="flex items-center justify-between mb-1">
                    <h3 className="flex items-center gap-3 text-base font-medium text-gray-800 dark:text-white/90">
                      Terminado
                      <span className="inline-flex rounded-full px-2 py-0.5 text-xs font-medium bg-success-50 text-success-700 dark:bg-success-500/15 dark:text-success-500">
                        4
                      </span>
                    </h3>
                    <div className="relative">
