              ...
              <div className="overflow-hidden">
                <div className="p-4 xl:p-6">
                  ...
                  <div className="min-h-[200px] space-y-5 mt-5">
                    {/* Tarea 1 */}
                    <div draggable="true" className="p-5 bg-brand-400 border border-gray-200 task rounded-xl shadow-theme-sm dark:border-gray-800 dark:bg-white/5" data-draggable="true">
