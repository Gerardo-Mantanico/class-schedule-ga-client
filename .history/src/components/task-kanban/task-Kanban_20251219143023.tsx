...
const KanbanBoard = () => {
                      ...
                      <div className="flex items-start justify-between gap-6">
                        <div>
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <Button variant="outline" size="sm" className="px-2 py-0.5 text-xs font-medium text-gray-600 dark:text-gray-300"> High Priority </Button>
                          </div>
                        </div>
  ...
  <div className="flex gap-3">
    ...
    <button className="shadow-theme-xs inline-flex h-11 items-center justify-center rounded-lg border border-gray-300 px-4 py-3 text-sm font-medium text-gray-700 dark:border-gray-700 dark:text-gray-400">
      Details
    </button>
  </div>

  <label htmlFor="toggle-2" className="cursor-pointer">
    <div className="relative">
      ...
      <div className="block h-6 w-11 rounded-full bg-brand-500 dark:bg-brand-500" />

      <div className="absolute top-0.5 left-0.5 h-5 w-5 translate-x-full rounded-full bg-white shadow-theme-sm duration-200 ease-linear" />
    </div>
  </label>
</div>
