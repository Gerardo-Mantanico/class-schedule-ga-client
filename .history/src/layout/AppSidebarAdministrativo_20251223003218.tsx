...
const navItems: NavItem[] = [
  {
  ...
  },
   {
    ...
    {
    icon: <ListIcon />,
    name: "Factura y control de pagos",
    subItems: [
      { name: "Pagos por sesión", path: "/administrativo/pagoSesion", pro: false },
      { name: "Historial de pagos", path: "/administrativo/historial", pro: false },
    ],
  },
];
