...
{estadoActual && estadoActual.id !== 0 && (
  <div className="mb-4 p-3 text-sm bg-yellow-100 rounded">
    Modo solo lectura: estado actual ya registrado
  </div>
)}
          ...
          <div className="space-y-3 rounded-lg bg-gray-50 p-4 dark:bg-gray-800">
            {escalaLikert.map((opcion) => (
              <Radio
                ...
                onChange={(v) =>
                  handleInputChange("estadoAnimo", parseInt(v))
                }
                disabled={isReadOnly}
              />
            ))}
          ...
          <div className="space-y-3 rounded-lg bg-gray-50 p-4 dark:bg-gray-800">
            {escalaLikert.map((opcion) => (
              <Radio
                ...
                onChange={(v) =>
                  handleInputChange("ansiedad", parseInt(v))
                }
                disabled={isReadOnly}
              />
            ))}
          ...
          <div className="space-y-3 rounded-lg bg-gray-50 p-4 dark:bg-gray-800">
            {escalaLikert.map((opcion) => (
              <Radio
                ...
                onChange={(v) =>
                  handleInputChange("calidadSueno", parseInt(v))
                }
                disabled={isReadOnly}
              />
            ))}
