...
interface EstadoActualProps {
  estadoAnimo?: number;
  ansiedad?: number;
  funcionamientoSocial?: number;
  calidadSueno?: number;
  apetito?: number;
  observacionesGenerales?: string;
  onChange?: (data: EstadoActualData) => void;
  disabled?: boolean;
}

export interface EstadoActualData {
  estadoAnimo: number;
  ansiedad: number;
  funcionamientoSocial: number;
  calidadSueno: number;
...
export default function EstadoActual({
  ...
  const [formData, setFormData] = useState<EstadoActualData>({
    estadoAnimo,
    ansiedad,
